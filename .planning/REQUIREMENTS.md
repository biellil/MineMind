...
- [x] **CRAFT-01**: O agente crafta itens verificando o inventário antes/depois (grounded)
- [x] **CRAFT-02**: O agente posiciona e usa a bancada de trabalho quando a receita exige (3x3)
- [x] **CRAFT-03**: O agente funde minérios na fornalha (smelting) e recupera o resultado
...
| CRAFT-01 | Phase 9 | Complete |
| CRAFT-02 | Phase 9 | Complete |
| CRAFT-03 | Phase 9 | Complete |
